/**
 * Handler della 404 per il group `(frontend)`.
 *
 ...
 *
 * Tenendo questo file dentro `(frontend)/`, Next lo seleziona quando
 * `notFound()` parte da una rotta del group (es. CmsPage), e il
 * rendering passa per `(frontend)/layout.tsx` → frontend.css incluso.
 */
