...
import { NAV_ICON_MAP } from "@/lib/admin/nav/icon-map";
...
// Le icone della nav vivono in un'unica mappa condivisa (NAV_ICON_MAP),
// usata anche da topbar/tabs/quick-actions. Il fallback resta `Settings`
// per coerenza storica con la sidebar (NAV_ICON_MAP.getNavIcon usa Plug).
const ICON_MAP = NAV_ICON_MAP;
