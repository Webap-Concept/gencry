...
// ──────────────────────────────────────────────────────────────────────────
// Feed/listing/metadata queries spostate in `lib/cms/news-feed-queries.ts`
// (CMS core) il 2026-05-21 perché i template news vivono in
// `app/(cms)/_templates/` (CMS core) e non devono dipendere dal modulo
// per renderizzare. Quel file espone:
//   - getRecentPublishedNewsCards / getNewsCardsByCategories /
//     getNewsCardsByParentPageId / getNewsMetadataByPageId
//   - getActiveNewsCategories / getCachedActiveNewsCategories
//   - types NewsCardData / NewsArticleMetadata / ActiveNewsCategory
// Il modulo continua a possedere le query specifiche del flusso
// scraping/AI/publish (sopra in questo file: sources, items, statuses,
// counts, picking batches, cleanup).
// ──────────────────────────────────────────────────────────────────────────
